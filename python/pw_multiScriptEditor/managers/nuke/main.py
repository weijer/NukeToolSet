...
Pass None for context to get results for all views and key times (as stored in a .ToolSets file)."""
        return ''
...
"""
    ...
    def writeKnobs(self ,i):
        """self.writeKnobs(i) -> String in .ToolSets form.
...
@return: String in .ToolSets form.
"""
        return ''
...
@param context: Optional context, default is current, None will be "contextless" (all views, all keys) as in a .ToolSets file.
@return: String.
"""
        return ''
...
Set value of the knob to a user defined script (TCL syntax, as in .ToolSets file). Return True if successful.
